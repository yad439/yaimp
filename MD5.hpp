...
private:
	static inline constexpr size_t BLOCK_SIZE = 64; // VC6 won't eat a const static int here
	...
	uint32_t _count[2]{0u, 0u};   // 64bit counter for number of bits (lo, hi)
	uint32_t _state[4]{0x67452301u, 0xefcdab89u, 0x98badcfeu, 0x10325476u};   // digest so far
